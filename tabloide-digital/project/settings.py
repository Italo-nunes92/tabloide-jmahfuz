...
ENV = BASE_DIR.parent / 'dotenv_files' / '.env'
...
DEBUG = bool(int(os.getenv('DEBUG', 'change-me')))
...
MIDDLEWARE = [
    ...
    # 'utils.tabloide_middleware.CidadeSelectionMiddleware',
...
STATIC_VERSION = '1.0.1'  # Atualize este número sempre que alterar o CSS
...
SUMMERNOTE_CONFIG = {
    ...
    # 'attachment_model': 'tabloide.PostAttachment',
}

AXES_ENABLED = True
AXES_FAILURE_LIMIT = 3
AXE_COOLOFF_TIME = 1 # 1 Hour
